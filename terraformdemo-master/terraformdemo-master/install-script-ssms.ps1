...
# URL Parameter
$WebURL = "https://installationpackages.s3.ap-south-1.amazonaws.com/SSMS-Setup-ENU.exe"
...
Start-Process -FilePath $FullFilePath -Args "/silent /install /Norestart" -Verb RunAs -Wait
